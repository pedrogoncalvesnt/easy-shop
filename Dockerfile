...
WORKDIR /src
COPY ["EasyShop.API/EasyShop.API.csproj", "EasyShop.API/"]
RUN dotnet restore "./EasyShop.API/EasyShop.API.csproj"
COPY . .
WORKDIR "/src/EasyShop.API"
